...
public class LogController {
    ...
    @GetMapping("/replies")
    public ResponseEntity<Collection<LogEntry>> getReplyLogs() {
        return new ResponseEntity<>(logService.getRepliesLog().toLogEntries(), HttpStatus.OK);
    }

    @GetMapping("/refused")
    public ResponseEntity<Collection<LogEntry>> getRefusedLogs() {
        return new ResponseEntity<>(logService.getRefusedLog().toLogEntries(), HttpStatus.OK);
    }
}
